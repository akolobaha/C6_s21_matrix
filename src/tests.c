...
START_TEST(create_matrix_1) {
  ...
  matrix_t B = {NULL, 0, 0};
  matrix_t C = {NULL, 0, 0};
  res1 = s21_create_matrix(5, 5, &A);
  ck_assert_int_eq(res1, 0);

  res2 = s21_create_matrix(5, 0, &B);
  ck_assert_int_eq(res2, 1);

  res3 = s21_create_matrix(1000, 10, &C);
...
//  s21_create_matrix(14, 14, &B);
//  s21_create_matrix(14, 14, &result_full);
//
//  for (int i = 0; i < A.rows; i++) {
//    for (int j = 0; j < A.columns; j++) {
//      A.matrix[i][j] = j + 1 + 0.0000001;
...
//  s21_remove_matrix(&B);
//
//  ck_assert_int_eq(s21_sub_matrix(&A, &result, &B), 0);
//
//  for (int i = 0; i < A.rows; i++) {
//    for (int j = 0; j < A.columns; j++) {
...
//  double res = 5.123f;
//  s21_create_matrix(4, 3, &A);
//  s21_create_matrix(4, 3, &result_full);
//
//  for (int i = 0; i < A.rows; i++) {
//    for (int j = 0; j < A.columns; j++) {
//      A.matrix[i][j] = 1.21030120f;
...
//  }
//
//  ck_assert_int_eq(s21_mult_number(&A, res, &result), 0);
//  s21_remove_matrix(&A);
//  s21_remove_matrix(&result);
//  s21_remove_matrix(&result_full);
}
...
//  }
//  A.rows = -1;
//  ck_assert_int_eq(s21_mult_number(&A, res, &result), 1);
//  A.rows = 4;
//
//  s21_remove_matrix(&A);
//  s21_remove_matrix(&result);
...
//  B.matrix[1][1] = 7;
//  B.matrix[1][2] = 3;
//  s21_create_matrix(3, 3, &result_full);
...
//  B.matrix[1][2] = 3;
//
//  ck_assert_int_eq(s21_mult_matrix(&A, &B, &result1), 0);
//
//  s21_create_matrix(3, 3, &result_full);
//  result_full.matrix[0][0] = 3;
...
//
//  ck_assert_int_eq(s21_eq_matrix(&result_full, &result2), 1);
//
//  s21_remove_matrix(&A);
//  s21_remove_matrix(&B);
...
//  ck_assert_int_eq(s21_determinant(&A, &res2), 0);
//
